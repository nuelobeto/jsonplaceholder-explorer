...
export const ROUTES = {
  ...
  dashboard: {
    ...
    userPosts: (id: number | string) => `/dashboard/users/${id}/posts`,
    userAlbums: (id: number | string) => `/dashboard/users/${id}/albums`,
    userTodos: (id: number | string) => `/dashboard/users/${id}/todos`,
